...
**ChildDev** — платформа с образовательными генераторами. MVP: «Филворд» с выдачей двухстраничного PDF (задание + ответы), ориентирована на кириллицу и крупную типографику.
...
### Ключевые эндпоинты
- `GET /filword` — основной UI генератора филвордов
- `POST /api/generate` — прокси к PDF-сервису
- `POST http://localhost:3001/generate` — эндпоинт генерации PDF
...
- **Двухстраничный PDF:** первая страница — задание, вторая — ответы
