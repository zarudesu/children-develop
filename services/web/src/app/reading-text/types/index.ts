...
export interface ReadingTextParams {
  // Основные параметры
  textType: ReadingTextType | ReadingTextType[]  // Поддержка множественного выбора
  inputText: string
  fontSize: FontSize
...
export const FONT_SIZE_SETTINGS: Record<FontSize, {
  ...
  'super-huge': {
    name: 'Супер огромный (40px)',
    description: 'Максимальный размер для особых потребностей',
    baseFontSize: 40,
    lineHeight: 2.4,
    cssSize: '40px'
  },
  ...
  'large': {
    name: 'Крупный (18px)',
    description: 'Для младших школьников',
    baseFontSize: 18,
    lineHeight: 1.8,
    cssSize: '18px'
  },
